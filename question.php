					...
					<?php
						...
						if(!$sqlstatus){
						  ...
						  $row = mysql_fetch_array($sqlstatus) 
							...
							<tr>
							<td><a href="user_profile.php?usernameviaget=<?php echo $row['user_ID'] ?>">
							<?php
                           ...
                           if(!$ansq){
							...
							<a href = "answer.php?questionid=<?php echo $qidget?>" title = "wanna answer this question"> <img src = "images/bulb.png" height="30" /> </a>
							<br>
							<br>
							<h3>Answers:</h3>
							...
							<tr>
							<td>
								<form action ="rate.php?answerid=<?php echo $rowans['answer_ID'] ?>&questionid=<?php echo $qidget ?>" method = "post" id = "rate">
