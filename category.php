					...
					<?php
						...
						if(!$sqlstatus){
						  ...
						  while ($row = mysql_fetch_array($sqlstatus)) {
							...
							mysql_select_db('askit');
							$sqlstatus3 = mysql_query($likequery,$connection);

							$sqlstatus4 = mysql_query($reportquery , $connection) ;
							...
							if(!$query3_result)
								{
									...
									<a href="like_in_category.php?questionid=<?php echo $row[0] ?>&category=<?php echo $cat?>">Like</a>
							...
							else
								{
									...
									<a href="unlike_in_category.php?questionid=<?php echo $row[0]?>&category=<?php echo $cat?>">Unlike</a>
